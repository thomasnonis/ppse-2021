...
\input{mainmatter/1-Abstract}
\input{mainmatter/2-Analisi dello schematico}
\input{mainmatter/3-Analisi Layout PCB}
\input{mainmatter/4-Firmware}
\input{mainmatter/5-Assemblaggio della scheda}
\input{mainmatter/6-Testing della scheda}
\input{mainmatter/7-Implementazioni future}

\input{mainmatter/8-Conclusioni}

\input{mainmatter/9-Bibliografia}

\input{mainmatter/10-Allegati}
