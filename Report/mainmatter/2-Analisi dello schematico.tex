...
\subsubsection{\texorpdfstring{Input 5V}}\label{input-5V}}
...
\subsubsection{\texorpdfstring{Input 12V}}\label{input-12V}}
...
\subsubsection{\texorpdfstring{Regolatore di tensione}}\label{regolatore-di-tensione}}
...
\(Vout = 0.768(1 + \frac{R10}{R11})\), per cui ne consegue che per una V_out di 3.3V,
\(\frac{R10}{R11} = \ 3.3\).
...
Per il dimensionamento dei filtri di ingresso e uscita ci siamo affidati alle 
