...
void oled_send_cmd(uint8_t cmd) {
    ...
    i2c_write_blocking(I2C_PERIPHERAL, (OLED_ADDR & OLED_WRITE_MODE), buf, 2, false);
}
...
void oled_send_buf(uint8_t buf[], int buflen) {
    ...
    temp_buf[0] = 0x40;
    i2c_write_blocking(I2C_PERIPHERAL, (OLED_ADDR & OLED_WRITE_MODE), temp_buf, buflen + 1, false);
